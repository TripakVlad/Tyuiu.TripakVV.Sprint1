using Tyuiu.TripakVV.Sprint1.Task7.V15.Lib;


namespace Tyuiu.TripakVV.Sprint1.Task7.V15
{
    class Programm
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнил: Трипак Владислав Валентинович | СМАРТб-23-1                   *");
            Console.WriteLine("***************************************************************************");
